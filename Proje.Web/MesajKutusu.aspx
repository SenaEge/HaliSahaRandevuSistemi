<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MesajKutusu.aspx.cs" Inherits="Proje.Web.MesajKutusu" %>
					...
					<form class="tg-loginform" method="post">
						<fieldset>
							...
							<div class="tg-description">
								<p>Üye olmadan devam et? <a href="Rezervation.aspx">Rezervasyon Yap</a></p>
							</div>
							<div class="tg-description">
								<p>Zaten bir hesabınız var mı? <a href="KullaniiciiGirisi.aspx">Giriş Yap</a></p>
							</div>
						</fieldset>
					</form>
				</div>
