<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Concatt.aspx.cs" Inherits="Proje.Web.Concatt" EnableEventValidation="false" %>
								...
								<div class="row">
									<div class="col-md-5 col-sm-12 col-xs-12">
										<div class="tg-contactinfobox">
											<div class="tg-section-heading"><h2>Sorularınızı, ÖNERİLERİNİZİ ve İSTEKLERİNİZİ BİZE ulaştırın  &amp; BİZ yapalım</h2></div>
											<div class="tg-description">
												<p>Yandaki iletişim formunu doldurarak yada aşağıdaki iletişim bilgilerinden 7/24 bize ulaşabilirsiniz</p>
											</div>
					...
					<form method="post">
						<fieldset>
							<div class="form-group">
								 ...
								 <asp:TextBox ID="TxtAd" runat="server" placeholder="Name*"  class="form-control"></asp:TextBox>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								   ...
								   <asp:TextBox ID="TxtEposta" runat="server"  placeholder="Konu*"  class="form-control"></asp:TextBox>
							</div>
							<div class="form-group">
								 
								  <asp:TextBox ID="TxtMesaj"  runat="server"  placeholder="Mesaj*"  class="form-control" Height="134px"></asp:TextBox>
							</div>
							<div class="form-group">
								<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
