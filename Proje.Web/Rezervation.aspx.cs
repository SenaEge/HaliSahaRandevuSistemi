...
namespace Proje.Web
{
    public partial class Rezervation : System.Web.UI.Page
    {
        ...
        private void findAvailableTable()
        {
            ...
            String mycon = "Data Source =DESKTOP-6U4094N; Initial Catalog=halisaha; Integrated Security=True";
            String myquery = "select DISTINCT tableno from Rezervation where ((dtstart between '" + startdate + "' and '" + enddate + "' ) or (dtend between '" + startdate + "' and '" + enddate + "' ))";
        ...
        public void GenerateBookingID()
        {
            ...
            String myquery = "select bookingid from Rezervation";
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = myquery;
            cmd.Connection = scon;
            SqlDataAdapter da = new SqlDataAdapter();
            ...
            else
            {
                ...
                String mycon1 = "Data Source =DESKTOP-6U4094N; Initial Catalog=halisaha; Integrated Security=True";
                SqlConnection scon1 = new SqlConnection(mycon1);
                String myquery1 = "select max(bookingid) from Rezervation";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            GenerateBookingID();
            String updatepass = "insert into Rezervation(bookingid,tableno,customername,totalperson,dtstart,dtend) values(" + bookingid + ",'" + RadioButtonList1.SelectedItem.Text + "','" + TextBox1.Text + "'," + TextBox2.Text + ",'" + startdate + "','" + enddate + "')";
            String mycon1 = "Data Source =DESKTOP-6U4094N; Initial Catalog=halisaha; Integrated Security=True";
