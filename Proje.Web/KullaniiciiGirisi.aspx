<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniiciiGirisi.aspx.cs" Inherits="Proje.Web.KullaniiciiGirisi" EnableEventValidation="false" %>
				...
				<div class="tg-formarea">
					...
					<form class="tg-loginform" method="post">
						<fieldset>
							...
							<div class="form-group">
								 <td class="auto-style6">Rolü&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							...
							<div class="form-group">
								...
								<asp:Button ID="Button1" runat="server" Text="Giriş" OnClick="Button1_Click" Height="30px" Width="79px" />
							</div>
							<div class="form-group">
								<a href="SifremiUnuttum.aspx">
									<em>Şifremi Unuttum</em>
									<i class="fa fa-question-circle"></i>
								</a>
							</div>
							<div class="tg-description">
								<p>Henüz hesabın yok mu? <a href="KullanicciiEkle.aspx">Kayıt Ol</a></p>
							</div>
						</fieldset>
					</form>
				</div>
